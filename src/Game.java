...
public class Game
{
	...
	public Game(GameView view, WordBank wordBank, ScoreBoard scoreBoard,
			Tracker tracker, GameMode standardMode, GameMode secretMode,
			QuestionTimer timer)
	{
		this.view = view;
	...
	private void startStandardRoundForCurrentCategory()
	{
		...
		currentQuestions = standardMode.buildRound(currentCategory, wordBank,
				standardModeQuestions);
	...
	private void startSecretModeRound()
	{
		...
		currentQuestions = secretMode.buildRound(currentCategory, wordBank,
				secretModeQuestions);
